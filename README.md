...
export MLFLOW_TRACKING_URI=https://dagshub.com/PUNAMRAMPUKALE/MachineLearningProjectWithMLFlow

export MLFLOW_TRACKING_USERNAME=PUNAMRAMPUKALE

export MLFLOw_PASSWORD=Punam@123
...
## 3. Create ECR repo to store/save docker image
    - Save the URI: 536453886414.dkr.ecr.us-east-2.amazonaws.com/mlproject
